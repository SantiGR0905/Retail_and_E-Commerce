...
public class SalesController : Controller
{
    ...
    public async Task<ActionResult> CreateSales([FromBody] SalesDto sale)
    {
        ...
        try
        {
            await _salesService.CreateSales(sale.StateSale, sale.Direction, sale.UserId, sale.PaymentMethodId);
        }
        catch (Exception ex)
        {
    ...
    public async Task<IActionResult> UpdateSales(int idsale, [FromBody] SalesDto sale)
    {
        ...
        try
        {
            await _salesService.UpdateSales(idsale, existingSales.SaleDate, sale.StateSale, sale.Direction, sale.UserId, sale.PaymentMethodId);
