...
namespace Retail.Migrations
{
    ...
    [Migration("20241103004057_UpdateInventoriesandProductDatabase")]
    partial class UpdateInventoriesandProductDatabase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Retail.Model.Products", b =>
                {
                    ...
                    b.HasOne("Retail.Model.Inventories", "Inventories")
                        .WithMany()
